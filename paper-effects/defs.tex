...
\newcommand{\stepsinprim}[1]{\Rightarrow^{#1}}
...
\newcommand{\calAg}{\calA^G}
\newcommand{\calAgplus}{\calA^{G+}}
\newcommand{\calAgtimes}{\calA^{G\otimes}}
...
\DeclareMathOperator{\cpure}{\mathsf{pure}}
\DeclareMathOperator{\ceff}{\mathsf{eff}}
...
% Algerbaic theories
\newcommand{\reader}[1]{\text{Reader}_{#1}}
\newcommand{\writer}[1]{\text{Writer}_{#1}}
\NewCommandCopy{\oldstate}{\state}
\renewcommand{\state}[1]{\text{State}_{#1}}
\newcommand{\nondet}{\text{Nondet}}
\newcommand{\steptheory}{\text{Step}}

\NewCommandCopy{\oldchoose}{\choose}
\renewcommand{\choose}{\text{choose}}
\newcommand{\lookup}{\text{lookup}}
\newcommand{\wrt}[1]{\text{write}({#1})}

\newcommand{\exn}[1]{\text{Exn}_{#1}}
\newcommand{\error}{\text{Error}}
\newcommand{\ex}[1]{\text{error}({#1})}
