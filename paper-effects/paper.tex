...
\title{Operational Semantics of Effectful Gradually Typed Languages in Guarded Type Theory}
...
\begin{abstract}
    Gradually-typed languages allow for soundly mixing static and dynamically
    ...
    \max{Expand this second paragraph}
