...
%\max{TODO: this should be the version with a tilde but I don't see that defined anywhere}
\begin{align*}
...
This relation is clearly transitive. We should also be able to show
that it is implied by both the strong error ordering as well as weak
bisimilarity of ITrees.
