...
to a guarded algebraic theory, given by $M_{\exn{E}}(\calA) := \calA +
\exn{E}$. Each theory transformer $M$ induces a corresponding \textbf{monad
transformer} that takes the free models of $\calA$ to the free models of
$M(\calA)$. Below we list the theory transformers we support, and their
