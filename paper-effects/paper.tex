...
\end{align*}
%
This is analogous to the usual notion of stateful operational semantics, in
which a term and an initial state are mapped to a final state and a returned
value. Here, $L$ accounts for errors and steps. 
