...
%
\begin{example}[Errors]\label{ex:err} The theory of computations that can error
    $\calA_{\err}$ is defined as follows. Let $\Sigma_{\err}$ contain a single
    operation $\errop$ with $\tau_{\errop} = 0$ and $\gamma_{\errop} = 1$. There
